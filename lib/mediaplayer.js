...
var MediaPlayer = module.exports = function (parent) {
  ...
  //this._vlcexcep = lib.libvlc_exception_init()
  ...
  this.seek = function (seek) {
    lib.libvlc_media_player_set_time(self.instance, seek);
  };

  this.setX11Window = function (wid) {
    lib.libvlc_media_player_set_xwindow(self.instance, wid);
  };

  this.setOSXWindow = function(nsobject) {
    lib.libvlc_media_player_set_drawable(self.instance, nsobject, 0);
  };

  this.setWin32Window = function(hwnd) {
    lib.libvlc_media_player_set_drawable(self.instance, hwnd, 0);
  };

  this.setTime = function (mstime) {
    lib.libvlc_media_player_set_time(self.instance, mstime);
  };

  this.setPosition = function (percentpostion) {
    lib.libvlc_media_player_set_position(self.instance, percentpostion);
  };

  this.getTime = function() {
    return lib.libvlc_media_player_get_time(self.instance);
  }

  this.getPosition = function () {
    return lib.libvlc_media_player_get_position(self.instance);
  };

  this.setFullscreen = function () {
    lib.libvlc_set_fullscreen(self.instance, 1);
  };
