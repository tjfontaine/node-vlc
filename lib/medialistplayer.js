...
var MediaListPlayer = module.exports = function (parent, medialist) {
  var self = this;
  var released = false;
  ...
  Object.defineProperty(this, 'playlist', {
	...
	set:function(list){
	  medialist=list
	  lib.libvlc_media_list_player_set_media_list(self.instance, medialist.instance);
	}
  });

  self.playlist=medialist;
  
  this.playItem=function(media){
	if(lib.libvlc_media_list_player_play_item(self.instance, media.instance)<0)
	{
		medialist.add(media);
		return this.playItem(media);
	}
  };
  
  Object.defineProperty(this, 'media', {
    get: function () {
      var mi = lib.libvlc_media_list_media(self.instance);
      return new Media(self.parent, mi);
    },
    set: function (val) {
      lib.libvlc_media_list_set_media(medialist.instance, val.instance);
    },
  });
  ...
  this.play = function (media) {
	if(media)
		...
		return lib.libvlc_media_list_player_play(self.instance) < 0 ? util.throw() : true;
  };
